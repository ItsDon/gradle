...
public class DefaultTestClassScanner implements Runnable {
    ...
    private void runPreviousFailedTestClasses() {
        for (String testClass : previousFailedTestClasses) {
            testClassProcessor.processTestClass(new PreviousFailedTestClassRunInfo(testClass));
        }
    }
    ...
    private void detectionScan() {
        ...
        candidateClassFiles.visit(new ClassFileVisitor() {
            public void visitClassFile(String className, FileVisitDetails fileDetails) {
    ...
    private abstract class ClassFileVisitor extends EmptyFileVisitor {
        ...
        public void visitFile(FileVisitDetails fileDetails) {
            ...
            if (!previousFailedTestClasses.contains(className)) {
                visitClassFile(className, fileDetails);
            }
        }

        public abstract void visitClassFile(String className, FileVisitDetails fileDetails);
